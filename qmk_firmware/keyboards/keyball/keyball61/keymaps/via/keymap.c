...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_universal(
    ...
    _______  , KC_LCTL         , KC_LALT         , KC_LGUI         ,LT(1,KC_ESC)     ,LT(2,KC_SPC),LT(3,KC_TAB), KC_ENT ,LT(2,KC_BSPC), LT(1,KC_DEL)    ,KC_RGUI          , _______         , KC_RALT            , KC_PSCR
  ),
  ...
  [2] = LAYOUT_universal(
    ...
    SSNP_VRT , _______  , KC_7 2    , KC_8     , KC_9     , _______  ,                                  _______  , KC_LEFT  , KC_UP    , KC_RGHT  , _______  , KC_F12   ,
