...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [4] = LAYOUT_universal(
    ...
    SSNP_VRT , _______  , _______  , _______  , KC_BTN3  , _______  ,                                  _______  , _______  , ______   , _______  , _______  , _______  ,
  ...
  [5] = LAYOUT_universal(
    ...
    SSNP_HOR , _______  , KC_4     , KC_5     , KC_6     ,S(KC_SCLN),                                  KC_0     , KC_4     , KC_5     , KC_6     , KC_0     ,
